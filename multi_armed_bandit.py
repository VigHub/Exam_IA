...
class MultiArmedBandit:
    def __init__(self, reward_prob_list):
        ...
        @:param reward_prob_list: probabilità reale di di ottenere la
        ricompensa da un determinato braccio/leva
        """
        self.reward_prob_list = reward_prob_list

    def step(self, choice):
        """ Abbassa il braccio selezionato (reward è 1 o 0)
         @:param choice: il braccio da abbassare
         @:return risultato dovuto all'aver abbassato quel braccio,
         """
